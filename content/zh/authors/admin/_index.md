...
你好！我是[香港中文大学（深圳）数据科学学院](https://sds.cuhk.edu.cn/en)的三年级博士生，师从[李彤欣](https://tongxin.me/)教授。我的研究兴趣主要集中在**生成式引擎优化（GEO）与营销AI智能体**、**上下文决策（In-Context Decision Making）**和**鲁棒大语言模型应用（Robust LLM Applications）**。
